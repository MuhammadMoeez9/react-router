        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-12">
            <div className="p-12 md:w-1/2 flex flex-col items-start">
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQik3OtLk6FhWiGSgW6YpZ2jrySm8EIR2wnVQ&s"></img>
            ...
            <div className="p-12 md:w-1/2 flex flex-col items-start">
              ...
              <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTdsKV1czL8C6kESP9HMjDhXUfAlWHnWXWvYw&s"></img>
              <p className="leading-relaxed mb-8">
                Live-edge letterpress cliche, salvia fanny pack humblebrag
                narwhal portland. VHS man braid palo santo hoodie brunch trust
                fund. Bitters hashtag waistcoat fashion axe chia unicorn. Plaid
